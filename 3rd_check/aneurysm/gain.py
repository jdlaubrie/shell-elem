...
#--------------------------------------------------------------------------
file_g01 = open('aneurysm_g01.rsn', 'r')
...
#--------------------------------------------------------------------------
file_g03 = open('aneurysm_g03.rsn', 'r')
...
#--------------------------------------------------------------------------
file_g04 = open('aneurysm_g04.rsn', 'r')
...
Data_g04.shape = (-1, 7)
Data_g04_t200 =  np.array([], dtype=np.int64)
Data_g04_t200.shape = (-1, 7)
for key in sorted(G04.keys()):
#    print key
    Data_g04 = np.append(Data_g04,[G04[key][0,:]], axis=0)

for node in range(NbrOfNodes):
    Data_g04_t200 = np.append(Data_g04_t200,[G04[key200][node,:]], axis=0)
...
plt.subplot(2,3,4)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,4]/1000.0,'b',label='Gain=0.01/T',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,4]/1000.0,'r',label='Gain=0.02/T',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,4]/1000.0,'g',label='Gain=0.03/T',linewidth=1.5,markersize=10)
plt.plot(Data_g04_t200[:,2]*1000.0,Data_g04_t200[:,4]/1000.0,'m',label='Gain=0.04/T',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,5)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,5]/1000.0,'b',label='Gain=0.01/T',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,5]/1000.0,'r',label='Gain=0.02/T',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,5]/1000.0,'g',label='Gain=0.03/T',linewidth=1.5,markersize=10)
plt.plot(Data_g04_t200[:,2]*1000.0,Data_g04_t200[:,5]/1000.0,'m',label='Gain=0.04/T',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 10},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(2,3,6)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,3]*1000.0,'b',label='Gain=0.01/T',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,3]*1000.0,'r',label='Gain=0.02/T',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,3]*1000.0,'g',label='Gain=0.03/T',linewidth=1.5,markersize=10)
plt.plot(Data_g04_t200[:,2]*1000.0,Data_g04_t200[:,3]*1000.0,'m',label='Gain=0.04/T',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 10},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
