...
plt.subplot(2,3,1)
plt.plot(Data_g01[:,0],Data_g01[:,4]/1000.0,'b',label='Oversizing=5%',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,4]/1000.0,'r',label='Oversizing=10%',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,4]/1000.0,'g',label='Oversizing=15%',linewidth=1.5,markersize=10)
plt.plot(Data_g04[:,0],Data_g04[:,4]/1000.0,'m',label='Oversizing=20%',linewidth=1.5,markersize=10)
...
plt.axis([0,180,0,110])

plt.subplot(2,3,2)
plt.plot(Data_g01[:,0],Data_g01[:,5]/1000.0,'b',label='Oversizing=5%',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,5]/1000.0,'r',label='Oversizing=10%',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,5]/1000.0,'g',label='Oversizing=15%',linewidth=1.5,markersize=10)
plt.plot(Data_g04[:,0],Data_g04[:,5]/1000.0,'m',label='Oversizing=20%',linewidth=1.5,markersize=10)
plt.xlabel(r'Time [months]', {'color': 'k', 'fontsize': 10})
...
plt.subplot(2,3,3)
plt.plot(Data_g01[:,0],Data_g01[:,3]*1000.0,'b',label='Oversizing=5%',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,3]*1000.0,'r',label='Oversizing=10%',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,3]*1000.0,'g',label='Oversizing=15%',linewidth=1.5,markersize=10)
plt.plot(Data_g04[:,0],Data_g04[:,3]*1000.0,'m',label='Oversizing=20%',linewidth=1.5,markersize=10)
plt.xlabel(r'Time [months]', {'color': 'k', 'fontsize': 10})
...
plt.text(0.95, 0.95, r'c',{'color': 'k', 'fontsize': 10,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,180,9.5,12])

plt.subplot(2,3,4)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,4]/1000.0,'b',label='Oversizing=5%',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,4]/1000.0,'r',label='Oversizing=10%',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,4]/1000.0,'g',label='Oversizing=15%',linewidth=1.5,markersize=10)
plt.plot(Data_g04_tstent[:,2]*1000.0,Data_g04_tstent[:,4]/1000.0,'m',label='Oversizing=20%',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,5)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,5]/1000.0,'b',label='Oversizing=5%',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,5]/1000.0,'r',label='Oversizing=10%',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,5]/1000.0,'g',label='Oversizing=15%',linewidth=1.5,markersize=10)
plt.plot(Data_g04_tstent[:,2]*1000.0,Data_g04_tstent[:,5]/1000.0,'m',label='Oversizing=20%',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(2,3,6)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,3]*1000.0,'b',label='Oversizing=5%',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,3]*1000.0,'r',label='Oversizing=10%',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,3]*1000.0,'g',label='Oversizing=15%',linewidth=1.5,markersize=10)
plt.plot(Data_g04_tstent[:,2]*1000.0,Data_g04_tstent[:,3]*1000.0,'m',label='Oversizing=20%',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
