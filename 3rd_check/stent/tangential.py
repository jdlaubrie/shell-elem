...
#--------------------------------------------------------------------------
file_g01 = open('stent_ct06.rsn', 'r')
...
#--------------------------------------------------------------------------
file_g03 = open('stent_ct14.rsn', 'r')
...
plt.subplot(2,3,1)
plt.plot(Data_g01[:,0],Data_g01[:,4]/1000.0,'b',label='$C_T$=6[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,4]/1000.0,'r',label='$C_T$=10[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,4]/1000.0,'g',label='$C_T$=14[kPa]',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,2)
plt.plot(Data_g01[:,0],Data_g01[:,5]/1000.0,'b',label='$C_T$=6[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,5]/1000.0,'r',label='$C_T$=10[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,5]/1000.0,'g',label='$C_T$=14[kPa]',linewidth=1.5,markersize=10)
plt.xlabel(r'Time [months]', {'color': 'k', 'fontsize':  10})
...
plt.subplot(2,3,3)
plt.plot(Data_g01[:,0],Data_g01[:,3]*1000.0,'b',label='$C_T$=6[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,3]*1000.0,'r',label='$C_T$=10[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,3]*1000.0,'g',label='$C_T$=14[kPa]',linewidth=1.5,markersize=10)
plt.xlabel(r'Time [months]', {'color': 'k', 'fontsize':  10})
...
plt.subplot(2,3,4)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,4]/1000.0,'b',label='$C_T$=6[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,4]/1000.0,'r',label='$C_T$=10[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,4]/1000.0,'g',label='$C_T$=14[kPa]',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,5)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,5]/1000.0,'b',label='$C_T$=6[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,5]/1000.0,'r',label='$C_T$=10[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,5]/1000.0,'g',label='$C_T$=14[kPa]',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize':  10})
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize':  10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(2,3,6)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,3]*1000.0,'b',label='$C_T$=6[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,3]*1000.0,'r',label='$C_T$=10[kPa]',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,3]*1000.0,'g',label='$C_T$=14[kPa]',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize':  10})
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize':  10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
