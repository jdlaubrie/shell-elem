...
#--------------------------------------------------------------------------
thefileso05 = ['surgery_g01cn25.rsn','surgery_g02cn25.rsn','surgery_g03cn25.rsn','surgery_g04cn25.rsn']
mesh0_data05 = {}
mesh1_data05 = {}
mesh2_data05 = {}
...
#--------------------------------------------------------------------------
thefileso10 = ['surgery_g01cn50.rsn','surgery_g02cn50.rsn','surgery_g03cn50.rsn','surgery_g04cn50.rsn']
mesh0_data10 = {}
mesh1_data10 = {}
mesh2_data10 = {}
...
#--------------------------------------------------------------------------
thefileso15 = ['surgery_g01cn75.rsn','surgery_g02cn75.rsn','surgery_g03cn75.rsn','surgery_g04cn75.rsn']
mesh0_data15 = {}
mesh1_data15 = {}
mesh2_data15 = {}
...
plt.subplot(3,3,1)
plt.plot(gain,Data0_o05[:,4]/1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data0_o10[:,4]/1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data0_o15[:,4]/1000.0,'mo',label='$C_N$=75[MPa]')
...
plt.text(0.95, 0.95, r'a',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,0,160])

plt.subplot(3,3,2)
plt.plot(gain,Data0_o05[:,5]/1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data0_o10[:,5]/1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data0_o15[:,5]/1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'b',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,0,350])

plt.subplot(3,3,3)
plt.plot(gain,Data0_o05[:,3]*1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data0_o10[:,3]*1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data0_o15[:,3]*1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'c',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,10,13.5])

plt.subplot(3,3,4)
plt.plot(gain,Data1_o05[:,4]/1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data1_o10[:,4]/1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data1_o15[:,4]/1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Axial Stress [kPa]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'd',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
...
plt.subplot(3,3,5)
plt.plot(gain,Data1_o05[:,5]/1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data1_o10[:,5]/1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data1_o15[:,5]/1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'e',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,0,350])

plt.subplot(3,3,6)
plt.plot(gain,Data1_o05[:,3]*1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data1_o10[:,3]*1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data1_o15[:,3]*1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'f',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,10,13.5])

plt.subplot(3,3,7)
plt.plot(gain,Data2_o05[:,4]/1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data2_o10[:,4]/1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data2_o15[:,4]/1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Axial Stress [kPa]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'g',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,0,160])

plt.subplot(3,3,8)
plt.plot(gain,Data2_o05[:,5]/1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data2_o10[:,5]/1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data2_o15[:,5]/1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'h',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,0,350])

plt.subplot(3,3,9)
plt.plot(gain,Data2_o05[:,3]*1000.0,'ro',label='$C_N$=25[MPa]')
plt.plot(gain,Data2_o10[:,3]*1000.0,'bo',label='$C_N$=50[MPa]')
plt.plot(gain,Data2_o15[:,3]*1000.0,'mo',label='$C_N$=75[MPa]')
plt.text(0.5,0.05,r'Gain parameter', {'color': 'k', 'fontsize': 8},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 8,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
plt.text(0.95, 0.95, r'i',{'color': 'k', 'fontsize': 8,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,0.05,10,13.5])
