...
#--------------------------------------------------------------------------
#--------------------------------------------------------------------------
file_g01 = open('surgery_r15.rsn', 'r')
...
#--------------------------------------------------------------------------
file_g03 = open('surgery_r85.rsn', 'r')
...
plt.subplot(4,3,1)
plt.plot(Data_g01[:,0],Data_g01[:,4]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,4]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,4]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
...
plt.axis([0,180,0,600])

plt.subplot(4,3,2)
plt.plot(Data_g01[:,0],Data_g01[:,5]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,5]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,5]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Time [months]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,3)
plt.plot(Data_g01[:,0],Data_g01[:,3]*1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,3]*1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,3]*1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Time [months]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
...
plt.text(0.95, 0.95, r'c',{'color': 'k', 'fontsize':  6,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
plt.axis([0,180,10,16])

plt.subplot(4,3,4)
plt.plot(Data_g01_gnra[:,2]*1000.0,Data_g01_gnra[:,4]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_gnra[:,2]*1000.0,Data_g02_gnra[:,4]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_gnra[:,2]*1000.0,Data_g03_gnra[:,4]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
...
plt.subplot(4,3,5)
plt.plot(Data_g01_gnra[:,2]*1000.0,Data_g01_gnra[:,5]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_gnra[:,2]*1000.0,Data_g02_gnra[:,5]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_gnra[:,2]*1000.0,Data_g03_gnra[:,5]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,6)
plt.plot(Data_g01_gnra[:,2]*1000.0,Data_g01_gnra[:,3]*1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_gnra[:,2]*1000.0,Data_g02_gnra[:,3]*1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_gnra[:,2]*1000.0,Data_g03_gnra[:,3]*1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,7)
plt.plot(Data_g01_stent[:,2]*1000.0,Data_g01_stent[:,4]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_stent[:,2]*1000.0,Data_g02_stent[:,4]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_stent[:,2]*1000.0,Data_g03_stent[:,4]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Axial Stress [kPa]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,8)
plt.plot(Data_g01_stent[:,2]*1000.0,Data_g01_stent[:,5]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_stent[:,2]*1000.0,Data_g02_stent[:,5]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_stent[:,2]*1000.0,Data_g03_stent[:,5]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,9)
plt.plot(Data_g01_stent[:,2]*1000.0,Data_g01_stent[:,3]*1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_stent[:,2]*1000.0,Data_g02_stent[:,3]*1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_stent[:,2]*1000.0,Data_g03_stent[:,3]*1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,10)
plt.plot(Data_g01_gnrb[:,2]*1000.0,Data_g01_gnrb[:,4]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_gnrb[:,2]*1000.0,Data_g02_gnrb[:,4]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_gnrb[:,2]*1000.0,Data_g03_gnrb[:,4]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Axial Stress [kPa]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,11)
plt.plot(Data_g01_gnrb[:,2]*1000.0,Data_g01_gnrb[:,5]/1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_gnrb[:,2]*1000.0,Data_g02_gnrb[:,5]/1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_gnrb[:,2]*1000.0,Data_g03_gnrb[:,5]/1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(4,3,12)
plt.plot(Data_g01_gnrb[:,2]*1000.0,Data_g01_gnrb[:,3]*1000.0,'b',label='Ratio=15%',linewidth=1.0,markersize=10)
plt.plot(Data_g02_gnrb[:,2]*1000.0,Data_g02_gnrb[:,3]*1000.0,'r',label='Ratio=50%',linewidth=1.0,markersize=10)
plt.plot(Data_g03_gnrb[:,2]*1000.0,Data_g03_gnrb[:,3]*1000.0,'g',label='Ratio=85%',linewidth=1.0,markersize=10)
plt.text(0.5,0.05,r'Axial position [mm]', {'color': 'k', 'fontsize':  6},
        ha='center',va='center',clip_on=False,transform=plt.gca().transAxes)
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize':  6,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
rects1 = ax.bar(index, radii, bar_width,
                ...
                error_kw=error_config, label='Media-Adventitia Ratio')

ax.set_xlabel('Media-Adventitia Ratio')
ax.set_ylabel('Radius [mm]')
ax.set_xticks(index + bar_width / 2)
ax.set_xticklabels(('0.15', '0.50', '0.85'))
plt.text(0.95, 0.95, r'b',{'color': 'k', 'fontsize': 20,
    'bbox': dict(boxstyle="round", fc="w", ec="k", pad=0.2)},
    ha='right',va='top',transform=plt.gca().transAxes)
...
FIGURENAME = 'sensitivity_ratio.eps'
plt.savefig(FIGURENAME)
plt.savefig(fname=FIGURENAME,
            dpi=None,
            facecolor='w',
