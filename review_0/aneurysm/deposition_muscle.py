...
#--------------------------------------------------------------------------
file_g01 = open('aneurysm_Gm105.rsn', 'r')
...
#--------------------------------------------------------------------------
file_g03 = open('aneurysm_Gm115.rsn', 'r')
...
plt.subplot(2,3,1)
plt.plot(Data_g01[:,0],Data_g01[:,4]/1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,4]/1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,4]/1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,2)
plt.plot(Data_g01[:,0],Data_g01[:,5]/1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,5]/1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,5]/1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
plt.xlabel(r'Time [months]', {'color': 'k', 'fontsize': 10})
...
plt.subplot(2,3,3)
plt.plot(Data_g01[:,0],Data_g01[:,3]*1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02[:,0],Data_g02[:,3]*1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03[:,0],Data_g03[:,3]*1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
plt.xlabel(r'Time [months]', {'color': 'k', 'fontsize': 10})
...
plt.subplot(2,3,4)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,4]/1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,4]/1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,4]/1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,5)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,5]/1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,5]/1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,5]/1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 10},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(2,3,6)
plt.plot(Data_g01_t200[:,2]*1000.0,Data_g01_t200[:,3]*1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02_t200[:,2]*1000.0,Data_g02_t200[:,3]*1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03_t200[:,2]*1000.0,Data_g03_t200[:,3]*1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 10},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
rects1 = ax.bar(index, radii, bar_width,
                ...
                error_kw=error_config, label='SMC Deposition Stretch')

ax.set_xlabel('$G^m_h$')
ax.set_ylabel('Radius [mm]')
ax.set_xticks(index + bar_width / 2)
ax.set_xticklabels(('1.05', '1.10', '1.15'))
...
FIGURENAME = 'sensitivity_muscle_depstr.eps'
plt.savefig(FIGURENAME)
plt.savefig(fname=FIGURENAME,
            dpi=None,
            facecolor='w',
