...
#--------------------------------------------------------------------------
file_g01 = open('stent_Gm105.rsn', 'r')
...
#--------------------------------------------------------------------------
file_g03 = open('stent_Gm115.rsn', 'r')
...
plt.subplot(2,3,4)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,4]/1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,4]/1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,4]/1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,5)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,5]/1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,5]/1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,5]/1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(2,3,6)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,3]*1000.0,'b',label='$G^m_h$=1.05',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,3]*1000.0,'r',label='$G^m_h$=1.10',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,3]*1000.0,'g',label='$G^m_h$=1.15',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
