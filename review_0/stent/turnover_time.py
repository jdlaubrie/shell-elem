...
plt.subplot(2,3,4)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,4]/1000.0,'b',label='$T^c$=$T^m$=70d',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,4]/1000.0,'r',label='$T^c$=$T^m$=85d',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,4]/1000.0,'g',label='$T^c$=$T^m$=101d',linewidth=1.5,markersize=10)
...
plt.subplot(2,3,5)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,5]/1000.0,'b',label='$T^c$=$T^m$=70d',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,5]/1000.0,'r',label='$T^c$=$T^m$=85d',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,5]/1000.0,'g',label='$T^c$=$T^m$=101d',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Circumferential Stress [kPa]',{'color': 'k', 'fontsize': 10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
...
plt.subplot(2,3,6)
plt.plot(Data_g01_tstent[:,2]*1000.0,Data_g01_tstent[:,3]*1000.0,'b',label='$T^c$=$T^m$=70d',linewidth=1.5,markersize=10)
plt.plot(Data_g02_tstent[:,2]*1000.0,Data_g02_tstent[:,3]*1000.0,'r',label='$T^c$=$T^m$=85d',linewidth=1.5,markersize=10)
plt.plot(Data_g03_tstent[:,2]*1000.0,Data_g03_tstent[:,3]*1000.0,'g',label='$T^c$=$T^m$=101d',linewidth=1.5,markersize=10)
plt.xlabel(r'Axial position [mm]', {'color': 'k', 'fontsize': 10})
plt.text(0.05, 0.5, r'Radius [mm]',{'color': 'k', 'fontsize': 10,},
        ha='left',va='center',rotation=90,clip_on=False,transform=plt.gca().transAxes)
