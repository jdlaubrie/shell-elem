...
!******************************************************************************
 SUBROUTINE shell2d_elem(NSTEP,time,dtime,nprops,props,nden,den,ndep,dep,ndamg,&
  ...
  CALL gauscheb(gpoin,gcoef)          !get Gauss points and coefficients
...
!******************************************************************************
 SUBROUTINE shell2d_gauss(NSTEP,time,dtime,noel,igaus,jgaus,xi,zeta,nprops,&
  ...
  REAL(kind=8) :: u(3),u3B,du(3),coords(2),et,zet
  ...
  CASE (3)
    CALL quadratic_shape_1d(xi,Nfunc,dNds)
  END SELECT
  ...
  CALL shell2d_gmatrix(Nfunc,dNds,u,u3B,du,cosd,coords,et,zet,g1_mb,g2_mb,g_pen)
...
!******************************************************************************
 SUBROUTINE shell2d_gmatrix(Nfunc,dNds,u,u3B,du,cosd,coords,et,zeta,g1_mb,g2_mb,g_pen)
  IMPLICIT NONE
  !external variables
  REAL(kind=8),INTENT(IN) :: Nfunc(nnode),dNds(nnode)
  REAL(kind=8),INTENT(IN) :: u(3),u3B,du(3),cosd(2),coords(2),et,zeta
